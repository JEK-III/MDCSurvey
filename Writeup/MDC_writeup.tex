...
We next sought to characterize the role that public data plays respondents research process by asking how frequently they used public data to generate ideas/hypotheses at the outset, to reach the main conclusion of a paper, or to support the main conclusion of a paper (Figure \ref{fig:results}b).
An overwhelming 96\% of respondents said that they do at least ``occasionally'' use public data in at least one capacity, and a 56\% majority used public data ``often.''
Although use peripheral to the main conclusions-- idea generation (41\% often, 46\% occasionally) and support (39\% often, 47\% occasionally)-- is somewhat more common, much of this use is central to research: 28\% often and 42\% occasionally use public data to reach the main conclusions of a paper.
...
However, only 35\% of the repositories that track downloads expose them on the landing page or via API; this ratio is roughly similar for all of the metrics we asked about. 
...
\cite{@sieber_not_1995, @mooney_anatomy_2011}. 
